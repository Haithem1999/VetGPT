...
def generate_response(prompt):
    ...
    You will also read and analyze uploaded documents if provided by the user and then answer any questions relevant to that document. If there are no provided documents from the user then do not ask for them (it is optional for the user to provide them). 
    ...
    user_prompt = f"{prompt}, attached document: {st.session_state.current_context}"
