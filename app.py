...
def generate_response(prompt):
    ...
    You will also read and analyze uploaded documents from the user and then answer any questions relevant to that document. Here is the medical document content to reference: {text}
